      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="bg-white/5 backdrop-blur-xl p-8 sm:p-10 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 text-sm mb-8">Create your CR account</p>
            ...
            <div className="text-center">
              <p className="text-gray-400 text-sm">
                ...
                <Link href="/cr/login" className="text-white hover:text-[#7C3AED] transition-colors font-medium">
                  Login
                </Link>
              </p>
            </div>
